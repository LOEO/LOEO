...
LEO.SUCCESS = "SUCCESS";
LEO.FAILED = "FAILED";
LEO.ENABLE = {"0": "禁用", "1": "启用"};
LEO.DataTable = function (id, options) {
    debugger;
    options = $.extend(true, {
        "select": "single",
...
/*LEO.initForm=function(options) {
    debugger;
    var $form = $("#"+options.id);
    $form.bootstrapValidator($.extend({}, LEO.validatorParser.getValidator($form), options.validators || {}));
...
//easyui
LEO.initGrid=function(id,options) {
...
LEO.openFormWin = function (id, opt,callback ) {
...
LEO.del = function (url, data, callback) {
...
LEO.treeGrid=function(id,options){
